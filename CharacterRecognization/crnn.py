...
class CRNN(object):
    ...
    def __init__(self, net_params, inputs, seq_len, batch_size, trainable=False, pretrain=False):
        ...
        self._input_height = int(net_params.get('net', 'input_height'))
        self._input_width = int(net_params.get('net', 'input_width'))
        self._class_num = int(net_params.get('net', 'classes_num'))
